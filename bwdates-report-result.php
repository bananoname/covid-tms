...
<head>
    ...
    <title>GHC Internal Portal | B/w Dates Report</title>
...
?>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">GHC Internal Portal - B/W Dates Report Result From <?php echo $fdate;?> to <?php echo $tdate;?> </h1>
